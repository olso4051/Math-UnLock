...
public final class LanguageQuestionContract extends QuestionContract {
	...
	public static final String[] ALL_COLUMNS = { BaseContract._ID, LANGUAGES[0], LANGUAGE_PRIORITIES[0], LANGUAGES[1],
			LANGUAGE_PRIORITIES[1], LANGUAGES[2], LANGUAGE_PRIORITIES[2], LANGUAGES[3], LANGUAGE_PRIORITIES[4], LANGUAGES[4],
			...
			LANGUAGE_PRIORITIES[16], LANGUAGES[17], LANGUAGE_PRIORITIES[17], QuestionContract.DIFFICULTY };
